...
#if (defined(ARDUINO_AVR_MEGA) || defined(ARDUINO_AVR_MEGA1280) || defined(ARDUINO_AVR_MEGA2560) || defined(__AVR_ATmega1280__) || \
...
#elif (defined(__AVR_ATmega1284P__) || defined(__AVR_ATmega1284__) || defined(__AVR_ATmega644P__) || defined(__AVR_ATmega644A__) ||                           \
       defined(__AVR_ATmega644__) || defined(__AVR_ATmega324PB__) || defined(__AVR_ATmega324PA__) || defined(__AVR_ATmega324P__) ||                           \
       defined(__AVR_ATmega324A__) || defined(__AVR_ATmega164P__) || defined(__AVR_ATmega164A__) || defined(__AVR_ATmega32__) || defined(__AVR_ATmega16__) || \
...
#endif
#elif defined(PORTA)
#define __digitalPinToPortReg(P) (((P) <= 7) ? &PORTB : (((P) >= 8 && (P) <= 15) ? &PORTD : (((P) >= 16 && (P) <= 23) ? &PORTC : &PORTA)))
#define __digitalPinToDDRReg(P) (((P) <= 7) ? &DDRB : (((P) >= 8 && (P) <= 15) ? &DDRD : (((P) >= 16 && (P) <= 23) ? &DDRC : &DDRA)))
#define __digitalPinToPINReg(P) (((P) <= 7) ? &PINB : (((P) >= 8 && (P) <= 15) ? &PIND : (((P) >= 16 && (P) <= 23) ? &PINC : &PINA)))
#if defined(SANGUINO_PINOUT)
#define __digitalPinToBit(P) (((P) <= 7) ? (P) : (((P) >= 8 && (P) <= 15) ? (P)-8 : (((P) >= 16 && (P) <= 23) ? (P)-16 : (7 - ((P)-24)))))
#else  // MightyCore Pinout
#define __digitalPinToBit(P) (((P) <= 7) ? (P) : (((P) >= 8 && (P) <= 15) ? (P)-8 : (((P) >= 16 && (P) <= 23) ? (P)-16 : (P)-24)))
#endif
#else
#define __digitalPinToPortReg(P) (((P) <= 7) ? &PORTB : (((P) >= 8 && (P) <= 15) ? &PORTD : &PORTC))
#define __digitalPinToDDRReg(P) (((P) <= 7) ? &DDRB : (((P) >= 8 && (P) <= 15) ? &DDRD : &DDRC))
#define __digitalPinToPINReg(P) (((P) <= 7) ? &PINB : (((P) >= 8 && (P) <= 15) ? &PIND : &PINC))
#if defined(SANGUINO_PINOUT)
#define __digitalPinToBit(P) (((P) <= 7) ? (P) : (((P) >= 8 && (P) <= 15) ? (P)-8 : (((P) >= 16 && (P) <= 23) ? (P)-16 : (7 - ((P)-24)))))
#else  // MightyCore Pinout
#define __digitalPinToBit(P) (((P) <= 7) ? (P) : (((P) >= 8 && (P) <= 15) ? (P)-8 : (((P) >= 16 && (P) <= 23) ? (P)-16 : (P)-24)))
...
#define __digitalPinToBit(P)      \
  (((P) <= 3)                     \
       ...
       : (((P) == 4 || (P) == 12) \
              ...
              : (((P) <= 8)       \
                     ? (P)-5      \
                     : (((P) <= 10) ? (P)-3 : (((P) == 11) ? 6 : (((P) <= 15) ? (P)-9 : (((P) <= 19) ? 23 - (P) : (((P) <= 21) ? 21 - (P) : (P)-18))))))))
#else

#define __digitalPinToPortReg(P)                                                                                         \
  ((((P) <= 4) || (P) == 6 || (P) == 12 || (P) == 24 || (P) == 25 || (P) == 29) ? &PORTD                                 \
                                                                                : (((P) == 5 || (P) == 13)      ? &PORTC \
                                                                                   : (((P) >= 18 && (P) <= 23)) ? &PORTF \
                                                                                                                : (((P) == 7) ? &PORTE : &PORTB)))
#define __digitalPinToDDRReg(P)                                                                                         \
  ((((P) <= 4) || (P) == 6 || (P) == 12 || (P) == 24 || (P) == 25 || (P) == 29) ? &DDRD                                 \
                                                                                : (((P) == 5 || (P) == 13)      ? &DDRC \
                                                                                   : (((P) >= 18 && (P) <= 23)) ? &DDRF \
                                                                                                                : (((P) == 7) ? &DDRE : &DDRB)))
#define __digitalPinToPINReg(P)                                                                                         \
  ((((P) <= 4) || (P) == 6 || (P) == 12 || (P) == 24 || (P) == 25 || (P) == 29) ? &PIND                                 \
                                                                                : (((P) == 5 || (P) == 13)      ? &PINC \
                                                                                   : (((P) >= 18 && (P) <= 23)) ? &PINF \
                                                                                                                : (((P) == 7) ? &PINE : &PINB)))
#define __digitalPinToBit(P)                                                                                                                 \
...
#elif (defined(ARDUINO_AVR_UNO) || defined(ARDUINO_AVR_DUEMILANOVE) || defined(__AVR_ATmega8__) || defined(__AVR_ATmega48__) || defined(__AVR_ATmega48P__) || \
       defined(__AVR_ATmega48PB__) || defined(__AVR_ATmega88P__) || defined(__AVR_ATmega88PB__) || defined(__AVR_ATmega168__) ||                              \
       defined(__AVR_ATmega168PA__) || defined(__AVR_ATmega168PB__) || defined(__AVR_ATmega328__) || defined(__AVR_ATmega328P__) ||                           \
       defined(__AVR_ATmega328PB__))

#if defined(__AVR_ATmega48PB__) || defined(__AVR_ATmega88PB__) || defined(__AVR_ATmega168PB__) || defined(__AVR_ATmega328PB__)
#define __digitalPinToPortReg(P) (((P) <= 7) ? &PORTD : (((P) >= 8 && (P) <= 13) ? &PORTB : (((P) >= 14 && (P) <= 19) ? &PORTC : &PORTE)))
#define __digitalPinToDDRReg(P) (((P) <= 7) ? &DDRD : (((P) >= 8 && (P) <= 13) ? &DDRB : (((P) >= 14 && (P) <= 19) ? &DDRC : &DDRE)))
#define __digitalPinToPINReg(P) (((P) <= 7) ? &PIND : (((P) >= 8 && (P) <= 13) ? &PINB : (((P) >= 14 && (P) <= 19) ? &PINC : &PINE)))
#define __digitalPinToBit(P) \
...
#define __digitalPinToBit(P) \
  ((P) <= 7 ? (P) : ((P) <= 13 ? ((P)-8) : ((P) == 14 ? 7 : ((P) <= 16 ? ((P)-14) : ((P) <= 18 ? ((P)-17) : ((P) == 25 ? 7 : ((P)-19)))))))
#else
...
#define __digitalReadFast(P) \
  (__builtin_constant_p(P)) ? ((BIT_READ(*__digitalPinToPINReg(P), __digitalPinToBit(P))) ? HIGH : LOW) : NonConstantsUsedForDigitalReadFast()
#else
#define digitalReadFast(P) ((int)__digitalReadFast((P)))
// since we have return values, it is easier to implement it by ?:
