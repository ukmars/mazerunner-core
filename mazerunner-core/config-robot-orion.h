...
//               speed, entry,   exit, angle, omega, alpha, sensor threshold
    {SEARCH_TURN_SPEED,    70,     80,    90,   280,  4000, TURN_THRESHOLD_SS90E}, // 0 => SS90EL
    {SEARCH_TURN_SPEED,    70,     80,   -90,   280,  4000, TURN_THRESHOLD_SS90E}, // 0 => SS90ER
    {SEARCH_TURN_SPEED,    70,     80,    90,   280,  4000, TURN_THRESHOLD_SS90E}, // 0 => SS90L
    {SEARCH_TURN_SPEED,    70,     80,   -90,   280,  4000, TURN_THRESHOLD_SS90E}, // 0 => SS90R
};
// clang-format on
